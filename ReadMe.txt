...
First, install all needed requirements from the requirements.txt file
Then, navigate to the parent folder for the project using your terminal (e.g. cd ~/Documents/DistanceTracker)
Then, type the command export FLASK_APP=distance_tracker
